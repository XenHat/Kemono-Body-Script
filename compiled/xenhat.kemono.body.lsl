...
attach(key id){
    ...
    http_response(key request_id,integer status,list metadata,string body)
    {
        ...
        if(new_version_s== "0.3.16" ) return;
        list cur_version_l=llParseString2List( "0.3.16" ,["."],[""]);
        ...
        +"/compare/"+ "0.3.16" +"..."+new_version_s+" Changes for "
        + "0.3.16" +"↛"+new_version_s+"]\n";
        ...
        llDialog(g_Owner_k, "Kemono-Body-Script"  + " v"+ "0.3.16"  +"\n"+g_cached_updateMsg_s,["Close"],-1);
    }
